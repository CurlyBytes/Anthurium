...
namespace Anthurium.API.Repositories.SqlServer {
  public class SqlServerDeliveryReceiptRepository
      : ISqlServerDeliveryReceiptRepository {
    ...
    public DeliveryReceipt DeliveryReceiptById(int Id) {
      // return _context.DeliveryReceipts.FirstOrDefault(p =>
      // p.DeliveryReceiptId == Id);
      return _context.DeliveryReceipts.Include(c => c.DeliveryReceiptDetails)
