...
namespace Anthurium.API.Migrations {
  [DbContext(
      typeof(AnthuriumContext))] partial class AnthuriumContextModelSnapshot
      : ModelSnapshot {
    protected override void BuildModel(ModelBuilder modelBuilder) {
#pragma warning disable 612, 618
      modelBuilder.HasAnnotation("ProductVersion", "3.1.11")
          .HasAnnotation("Relational:MaxIdentifierLength", 64);

      modelBuilder.Entity("Anthurium.Shared.Models.Asset", b => {
        b.Property<int>("AssetId").ValueGeneratedOnAdd().HasColumnType("int");

        b.Property<int>("ClientInformationId").HasColumnType("int");

        b.Property<DateTime>("DateCreated").HasColumnType("datetime(6)");

        b.Property<DateTime>("DateRecieve").HasColumnType("datetime(6)");

        b.Property<DateTime>("DateUpdated").HasColumnType("datetime(6)");
        ...
        b.Property<DateTime>("WarrantyDate").HasColumnType("datetime(6)");
      ...
      modelBuilder.Entity("Anthurium.Shared.Models.DeliveryReceipt", b => {
        ...
        b.Property<int>("JobQuotationId").HasColumnType("int");
      ...
      modelBuilder.Entity(
          "Anthurium.Shared.Models.DeliveryReceiptDetails", b => {
            ...
            b.Property<int>("DeliveryReceiptId").HasColumnType("int");
      ...
      modelBuilder.Entity("Anthurium.Shared.Models.JobOrder", b => {
        ...
        b.Property<DateTime>("DateSchedule").HasColumnType("datetime(6)");
        ...
        b.Property<int>("RemainingHours").HasColumnType("int");

        b.Property<DateTime>("TimeEnded").HasColumnType("datetime(6)");

        b.Property<DateTime>("TimeStarted").HasColumnType("datetime(6)");

        b.Property<int>("TotalHours").HasColumnType("int");
      ...
      modelBuilder.Entity(
          "Anthurium.Shared.Models.JobOrderDescriptionOfWork", b => {
            ...
            b.Property < int ? > ("JobOrderId").HasColumnType("int");
      ...
      modelBuilder.Entity("Anthurium.Shared.Models.JobQuotation", b => {
        ...
        b.Property<double>("OverallCost").HasColumnType("double");
      ...
      modelBuilder.Entity("Anthurium.Shared.Models.JobQuotationDetails", b => {
        ...
        b.Property<bool>("IsAlreadyPurchaseOrder").HasColumnType("tinyint(1)");
        ...
        b.Property<double>("MarginPrice").HasColumnType("double");

        b.Property<double>("OriginalPrice").HasColumnType("double");
        ...
        b.Property<double>("SellingPrice").HasColumnType("double");

        b.Property<double>("TotalCost").HasColumnType("double");
      ...
      modelBuilder.Entity("Anthurium.Shared.Models.User", b => {
        ...
        b.Property<byte[]>("PasswordHash").HasColumnType("longblob");

        b.Property<byte[]>("PasswordSalt").HasColumnType("longblob");
      ...
      modelBuilder.Entity("Anthurium.Shared.Models.Vendor", b => {
        b.Property<int>("VendorId").ValueGeneratedOnAdd().HasColumnType("int");
      ...
      modelBuilder.Entity("Anthurium.Shared.Models.Asset", b => {
        b.HasOne("Anthurium.Shared.Models.ClientInformation",
                 "ClientInformation")
            .WithMany("Asset")
      ...
      modelBuilder.Entity("Anthurium.Shared.Models.DeliveryReceiptDetails",
                          b => {
                            b.HasOne("Anthurium.Shared.Models.DeliveryReceipt",
                                     "DeliveryReceipt")
