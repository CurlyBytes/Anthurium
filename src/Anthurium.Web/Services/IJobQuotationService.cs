...
namespace Anthurium.Web.Services {
  public interface IJobQuotationService {
    Task<HttpResponseMessage> CreateJobQuotationAsync(
        JobQuotationCreateDto clientinformation);
    ...
    Task<JobQuotationApiResponse> GetJobQuotationsAsync(string orderBy,
                                                        int skip, int top);
    Task<JobQuotationApiResponse> JobOrderQuotationByClient(
